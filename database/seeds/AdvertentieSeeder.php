...
class AdvertentieSeeder extends Seeder
{
	...
	public function run()
	{
		...
		function createAdvertentie() {
			...
			//seeding information
			$titleSubjects = explode(";","Jas;Laptop;Motorfiets;Telefoon;Piano;Standbeeld;Munt;Mariabeeld;Katholiek Kruis;Kast;Boog;Springkussen;Foto Sinterklaas;Kerst Beeldjes");
			...
			DB::table('advertenties')->insert([
				...
				'title' => $prefixes[array_rand($prefixes)].$titleSubjects[$randomInt-1],
